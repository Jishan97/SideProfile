...
const ProjectLeft = (props) => {
    ...
    const { title, tag, desc, image, link } = props.data
    return (
        <Container className = {classes.root} >
            <Grid container >
                <Grid item md = {7} xs = {12} className = {classes.mobile} >
                ...
                <Grid item md = {5} xs = {12} >
                    <div className = {classes.textSec} >
                        ...
                        <a href = {link} rel="noreferrer" target = "_blank" ><button className = {classes.customBtn} >  View Project  </button></a>
                        </div>
                    </div>
                </Grid>
                <Grid item md = {7} xs = {12} className = {classes.desktop} >
                    <div style = {{textAlign : "center"}}>
                        <img src = {image} alt = 'mockup' className = {classes.imgStyle} />
                    </div>
                </Grid>
